...
import { Main, Login, Dashborad } from "./containers";
  ...
  return (
    <div className="w-screen min-h-screen h-auto flex flex-col items-center justify-center">
      {isloading && (
        <motion.div
          {...fadeInOut}
          className="fixed z-50 inse' 
       backdrop-blur-md  w-full flex  items-center justify-center h-full"
        >
          {/* <div
            aria-label="Loading..."
            role="status"
          ...
          {/* <div class="w-full h-screen bg-gray-900 dark:bg-white">
            <div class="w-[10rem] h-[10rem] grid place-items-center absolute top-[40%] sm:right-[40%] xs:right-[30%] [transition:all_400ms_ease] hover:-translate-y-[1rem]">
              ...
              <p class="bg-gradient-to-r from-sky-500 to-yellow-500/30 rounded-full text-center inline-flex items-center text-[#000e17] font-semibold w-[10rem] h-[10rem] flex justify-center animate-[spinOut_1s_linear_infinite]">
                <h3 class="absolute -rotate-[360deg] text-white text-sm font-serif font-semibold">
                  LOADING ...
                </h3>
              </p>
            </div>
          ...
          <div class="bg-white dark:bg-gray-800 flex justify-center items-center w-screen h-screen p-5">
            <div class="border border-gray-200 p-2 rounded-md shadow-lg shadow-orange-300">
              <div class="flex items-end gap-1">
                <span class="text-6xl font-semibold dark:text-white">F</span>
                <svg
                  class="animate-spin"
                  fill="#F97316"
                  width="30px"
                ...
                <span class="text-6xl font-semibold dark:text-white">D</span>
                <span class="text-6xl font-semibold text-orange-500">
                  Track
                </span>
              </div>
            </div>
